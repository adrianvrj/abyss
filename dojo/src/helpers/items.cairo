    ...
    items
        .append(
            Item {
                item_id: 12,
                name: 'Skull',
                description: '+7% cherry probability',
                price: 1,
                sell_price: 0,
                effect_type: 2,
                effect_value: 7,
    ...
    items
        .append(
            Item {
                item_id: 16,
                name: 'Weird Hand',
                description: '+13% cherry probability',
                price: 2,
                sell_price: 1,
                effect_type: 2,
                effect_value: 13,
    ...
    items
        .append(
            Item {
                item_id: 28,
                name: 'Devil Head',
                description: '+19% cherry probability',
                price: 4,
                sell_price: 2,
                effect_type: 2,
                effect_value: 19,
