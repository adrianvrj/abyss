...
export const STATIC_ITEM_DEFINITIONS: Record<number, StaticItemDefinition> = {
  ...
  12: { name: "Skull", description: "+10% cherry probability", price: 1, sell_price: 0, effect_type: 2, effect_value: 10, target_symbol: "cherry" },
  ...
  14: { name: "Old Wig", description: "+2 to lemon score on pattern", price: 1, sell_price: 0, effect_type: 3, effect_value: 2, target_symbol: "lemon" },
