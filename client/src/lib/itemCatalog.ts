...
export const STATIC_ITEM_DEFINITIONS: Record<number, StaticItemDefinition> = {
  1: { name: "Chilly Pepper", description: "+3 to seven score on pattern", price: 1, sell_price: 0, effect_type: 3, effect_value: 3, target_symbol: "seven" },
  ...
  11: { name: "Ghost Mask", description: "+10% seven probability", price: 3, sell_price: 1, effect_type: 2, effect_value: 10, target_symbol: "seven" },
  ...
  17: { name: "Golden Globe", description: "-3 coin weight", price: 1, sell_price: 0, effect_type: 2, effect_value: 3, target_symbol: "anti-coin" },
  18: { name: "Pyramid", description: "+3 instant spins", price: 5, sell_price: 2, effect_type: 4, effect_value: 3, target_symbol: "" },
  19: { name: "Old Phone", description: "+1 to coin score on pattern", price: 2, sell_price: 1, effect_type: 3, effect_value: 1, target_symbol: "coin" },
  ...
  25: { name: "Hockey Mask", description: "+7 to seven score on pattern", price: 2, sell_price: 1, effect_type: 3, effect_value: 7, target_symbol: "seven" },
  ...
  31: { name: "Beer Can", description: "-5 coin weight", price: 3, sell_price: 1, effect_type: 2, effect_value: 5, target_symbol: "anti-coin" },
  32: { name: "Memory Card", description: "-7 coin weight", price: 4, sell_price: 2, effect_type: 2, effect_value: 7, target_symbol: "anti-coin" },
  33: { name: "Ticket", description: "+10 to seven score on pattern", price: 3, sell_price: 2, effect_type: 3, effect_value: 10, target_symbol: "seven" },
