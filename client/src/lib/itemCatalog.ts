...
export const STATIC_ITEM_DEFINITIONS: Record<number, StaticItemDefinition> = {
  ...
  11: { name: "Ghost Mask", description: "+12 seven weight", price: 3, sell_price: 1, effect_type: 2, effect_value: 12, target_symbol: "seven" },
  ...
  34: { name: "Devil Train", description: "+16 seven weight", price: 4, sell_price: 2, effect_type: 2, effect_value: 16, target_symbol: "seven" },
