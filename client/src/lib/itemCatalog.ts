...
export const STATIC_ITEM_DEFINITIONS: Record<number, StaticItemDefinition> = {
  ...
  2: { name: "Milk", description: "+3 diamond score, +1 CHIP on diamond hit", price: 1, sell_price: 0, effect_type: 3, effect_value: 3, target_symbol: "diamond" },
  ...
  7: { name: "Nerd Glasses", description: "+8 seven weight", price: 1, sell_price: 0, effect_type: 2, effect_value: 8, target_symbol: "seven" },
  ...
  11: { name: "Ghost Mask", description: "+11 seven weight", price: 3, sell_price: 1, effect_type: 2, effect_value: 11, target_symbol: "seven" },
  12: { name: "Skull", description: "+7 cherry weight", price: 1, sell_price: 0, effect_type: 2, effect_value: 7, target_symbol: "cherry" },
  ...
  16: { name: "Weird Hand", description: "+13 cherry weight", price: 2, sell_price: 1, effect_type: 2, effect_value: 13, target_symbol: "cherry" },
  17: { name: "Golden Globe", description: "-7 coin weight", price: 1, sell_price: 0, effect_type: 2, effect_value: 7, target_symbol: "anti-coin" },
  ...
  26: { name: "Rune", description: "+4 diamond score, +2 CHIP on diamond hit", price: 3, sell_price: 1, effect_type: 3, effect_value: 4, target_symbol: "diamond" },
  ...
  28: { name: "Devil Head", description: "+19 cherry weight", price: 4, sell_price: 2, effect_type: 2, effect_value: 19, target_symbol: "cherry" },
  ...
  31: { name: "Beer Can", description: "-12 coin weight", price: 2, sell_price: 1, effect_type: 2, effect_value: 12, target_symbol: "anti-coin" },
  32: { name: "Memory Card", description: "-17 coin weight", price: 3, sell_price: 2, effect_type: 2, effect_value: 17, target_symbol: "anti-coin" },
  ...
  34: { name: "Devil Train", description: "+12 seven weight", price: 4, sell_price: 2, effect_type: 2, effect_value: 12, target_symbol: "seven" },
  35: { name: "Fake Dollar", description: "+5 diamond score, +3 CHIP on diamond hit", price: 4, sell_price: 1, effect_type: 3, effect_value: 5, target_symbol: "diamond" },
