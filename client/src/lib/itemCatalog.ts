...
export const STATIC_ITEM_DEFINITIONS: Record<number, StaticItemDefinition> = {
  ...
  7: { name: "Nerd Glasses", description: "+6 seven weight", price: 1, sell_price: 0, effect_type: 2, effect_value: 6, target_symbol: "seven" },
  ...
  11: { name: "Ghost Mask", description: "+9 seven weight", price: 3, sell_price: 1, effect_type: 2, effect_value: 9, target_symbol: "seven" },
  ...
  34: { name: "Devil Train", description: "+10 seven weight", price: 4, sell_price: 2, effect_type: 2, effect_value: 10, target_symbol: "seven" },
