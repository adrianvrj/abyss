...
export const STATIC_ITEM_DEFINITIONS: Record<number, StaticItemDefinition> = {
  ...
  17: { name: "Golden Globe", description: "-5 coin weight", price: 1, sell_price: 0, effect_type: 2, effect_value: 5, target_symbol: "anti-coin" },
  ...
  31: { name: "Beer Can", description: "-8 coin weight", price: 1, sell_price: 1, effect_type: 2, effect_value: 8, target_symbol: "anti-coin" },
  32: { name: "Memory Card", description: "-11 coin weight", price: 2, sell_price: 1, effect_type: 2, effect_value: 11, target_symbol: "anti-coin" },
  ...
  39: { name: "Knight Helmet", description: "-6 coin weight", price: 1, sell_price: 1, effect_type: 2, effect_value: 6, target_symbol: "anti-coin" },
