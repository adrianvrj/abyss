...
export const STATIC_CHARM_DEFINITIONS: Record<number, StaticCharmDefinition> = {
  ...
  4: { charm_id: 4, name: "Dusty Hourglass", description: "Time bends for the desperate.", rarity: "Common", effect: "+8 Luck if spins remaining <= 2", luck: 8, shop_cost: 1, image: charmImage(4), background_color: "#6B7280" },
  ...
  11: { charm_id: 11, name: "Shadow Lantern", description: "Its light grows brighter as you descend deeper.", rarity: "Rare", effect: "+8 Luck, +8 more at level 5+", luck: 8, shop_cost: 2, image: charmImage(11), background_color: "#2563EB" },
  ...
  17: { charm_id: 17, name: "Reaper's Mark", description: "Death marks every pattern except jackpot for a second harvest.", rarity: "Epic", effect: "All non-jackpot patterns trigger twice", luck: 0, shop_cost: 5, image: charmImage(17), background_color: "#7C3AED" },
  18: { charm_id: 18, name: "Chaos Orb", description: "Chaos rewards survival.", rarity: "Epic", effect: "+80 Luck if 666 was blocked this session", luck: 80, shop_cost: 5, image: charmImage(18), background_color: "#7C3AED" },
